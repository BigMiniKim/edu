...
<body>
	<%
	Object obj1 = session.getAttribute("sessionName"); //꺼내기 위해선 형변환 필요
	...
	while (enumeration.hasMoreElements()) {
		...
		value = session.getAttribute(name).toString(); //object라 toString
